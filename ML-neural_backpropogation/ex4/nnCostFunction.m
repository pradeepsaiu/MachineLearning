...
J = ComputeCost(X,y,Theta1,Theta2);
...
reg = (lambda/(2*m)) * (sum(reg_theta2(:))+sum(reg_theta1(:)));
...
%               first time.
%
[a,b,z2,a2,z3,a3] = predict(Theta1, Theta2, X);
...
tri1 = del2' * [ones(m, 1) X];

tri2 = del3' * a2;

Theta1_grad =tri1.*(1/m);

Theta2_grad = tri2.*(1/m);
